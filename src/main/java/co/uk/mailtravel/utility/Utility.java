package co.uk.mailtravel.utility;
...
public class Utility extends BasePage {
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/co/uk/mailtravel/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/co/uk/mailtravelscreenshots/" + screenshotName + dateName + ".png";
